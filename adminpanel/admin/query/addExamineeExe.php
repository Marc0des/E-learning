...
{
	$insData = $conn->query("INSERT INTO examinee_tbl(exmne_fullname,exmne_course,exmne_gender,exmne_birthdate,exmne_Academic_level,exmne_email,exmne_password) VALUES('$fullname','$course','$gender','$bdate','$Academic_level','$email','$password')  ");
	if($insData)
	{
