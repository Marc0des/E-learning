    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                 ...
                 <li>
                                            <a href="home.php?page=manage-file">
                                                <i class="metismenu-icon pe-7s-video">
                                                </i>All Lesson
                                            </a>
                </li>

                <li class="app-sidebar__heading">TO-ANSWER PRE-TEST</li>

                <li>
                <a href="#">
                     <i class="metism7 enu-icon"></i>
                     Pre-Test
                ...
                <ul >
                    <?php 
                        ...
                        { ?>
                            <a href="#">
                                <i class="metismenu-icon"></i>No Pre-test @ the moment
                            </a>
                        <?php }
                     ?>
                </ul>
                ...
                <li class="app-sidebar__heading">TO-ANSWER POST-TEST</li>
                ...
                <a href="#">
                 ...
                 <li class="app-sidebar__heading">DONE</li>
                <li>
                <a href="#">
                     <i class="metism7 enu-icon"></i>
                     All Test Taken
                    ...
                    { ?>
                        <a href="#" class="pl-3">Take your PRE AND POST TEST</a>
                    <?php }
